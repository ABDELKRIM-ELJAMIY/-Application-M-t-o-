...
function fetchWeather(location) {
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            humidityElement.innerHTML = ` <box-icon name='water' id="hum"></box-icon> <br> Humidity: ${data.main.humidity}%`;
            windDirectionElement.innerHTML = `<box-icon name='wind'></box-icon> <br>Wind speed: ${data.wind.speed} km/h`;
...
function toggleFavoritesDisplay() {
    ...
    const toggleButton = document.getElementById("showFavoritesButton");

    if (favoritesContainer.style.display === "none" || favoritesContainer.style.display === "") {
        favoritesContainer.style.display = "block";
        toggleButton.innerHTML = "<box-icon name='star' type='solid'></box-icon>";
    } else {
        favoritesContainer.style.display = "none";
        toggleButton.innerHTML = "<box-icon name='star'  ></box-icon>";
    }
}
